...
get_recipe = Food().get_recipe_by_id
...
class Food_test(unittest.TestCase):
    ...
    def test_food_categories(self):
        self.assertEqual(['Beef', 'Chicken', 'Dessert', 'Lamb', 'Miscellaneous', 'Pasta', 'Pork', 'Seafood', 'Side', 'Starter', 'Vegan', 'Vegetarian', 'Breakfast', 'Goat'], Food().get_food_categories())
...
# print(Food().get_food_categories())